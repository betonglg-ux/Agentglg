...
### Экспорт в зеркало
- выполнен автоматический экспорт в GitHub-зеркало и пересборка служебных индексов.
- после повторной хэш-сверки с текущей рабочей средой подтверждено, что рабочая память, переносимые инструкции и шаблоны протоколов совпадают с GitHub-зеркалом; обновления требуют только актуальные версии `attached-files-index.md` и этого changelog.

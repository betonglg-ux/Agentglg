...
Когда пользователь присылает PDF-протокол или несколько протоколов, всегда в первую очередь работай по регламенту из навыка {{label:glavlab-protocol-review,id:hsk_69f06d75ac9c81919f5aabf37324ee07,type:skill}}.

...
### Экспорт в зеркало
- выполнен автоматический экспорт в GitHub-зеркало и пересборка служебных индексов.
- после повторной хэш-сверки с текущей рабочей средой подтверждено, что рабочая память и индекс шаблонов совпадают с GitHub-зеркалом; обновления требуют только устаревшие копии инструкций и индекс `attached-files-index.md`.

...
- GitHub не заменяет текущую конфигурацию агента во время выполнения задач, а хранит ее чистую, переносимую и регулярно актуализируемую копию.
...
Канонические файлы памяти в рабочей среде:
...
Канонические копии этих файлов в GitHub:
...
- `automation/`
- `agent-development/`
- `agent-development/CANONICAL-MEMORY.md`
- `agent-development/MEMORY-SYNC-STATUS.md`
- `agent-development/confirmed-error-patterns.md`
- `agent-development/missed-findings-log.md`
- `agent-development/template-notes.md`
- `agent-development/user-confirmed-corrections.md`
...
- не считай синхронизацию успешной, если хотя бы один из четырех канонических файлов памяти не совпал между рабочей памятью, `agent-development/*.md` и `agent-development/memory-exports/raw-memory/*.md`.
...
- сохраняй материалы в максимально понятной структуре: automation отдельно, навыки отдельно, каноническая память отдельно, контрольные raw-копии отдельно;
...
- GitHub должен как можно быстрее догонять эти изменения и хранить их актуальные копии;

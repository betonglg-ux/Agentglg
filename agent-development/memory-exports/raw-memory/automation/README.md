...
- если локальная память случайно стала беднее, чем файл в GitHub-зеркале, синхронизация остановится с ошибкой вместо того, чтобы затереть более полную версию;
